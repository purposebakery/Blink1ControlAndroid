...
//      Color c = new Color( r,g,b );
   ...
   * @returns blink1_command response code, -1 == fail 
   */
  public int setRGB(int c) {
    return setRGB(Color.red(c), Color.green(c), Color.blue(c) );
  }
   ...
   * @returns blink1_command response code, -1 == fail 
   */
  public int fadeToRGB(int fadeMillis, int c) {
    return fadeToRGB( fadeMillis, Color.red(c), Color.green(c), Color.blue(c) );
  }
   ...
   * @returns blink1_command response code, -1 == fail 
   */
  public int fadeToRGB(int fadeMillis, int c, int ledn) {
    return fadeToRGB( fadeMillis, Color.red(c), Color.green(c), Color.blue(c), ledn );
  }
   ...
   * @returns blink1_command response code, -1 == fail 
   */
  public int writePatternLine(int fadeMillis, int c, int pos) {
    return writePatternLine(fadeMillis, Color.red(c), Color.green(c), Color.blue(c), pos);
  }
